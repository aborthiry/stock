...
from .models import RenglonOrden
...
class RenglonOrdenAdmin(admin.ModelAdmin):
    name = 'Renglones'
...
class OrdenAdmin(admin.ModelAdmin):
    ...
    inlines = [LibroInline]
    name = 'Ordenes'
    list_display = ('puntodeventa','tipodeorden','fechaorden','added_by')
    #search_fields = ('libro','puntodeventa')
    list_filter = ('puntodeventa','fechaorden',)
    exclude = ['added_by',]
...
class DestinatarioDeVentaAdmin(admin.ModelAdmin):
    list_display = ('nombre','direccion','telefono',)
...
admin.site.register(Destinatario, PuntoDeVentaAdmin)
admin.site.register(Coleccion, ColeccionAdmin)
admin.site.register(Orden, OrdenAdmin)
admin.site.register(Stock, StockAdmin)
admin.site.register(RenglonOrden, RenglonOrdenAdmin)
